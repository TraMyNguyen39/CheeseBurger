...
{
    public class MyAlternateOrderModel : PageModel
    {
		...
		public MyAlternateOrderModel(IOrderService orderService, IOrder_FoodService order_FoodService, ICartService cartService,
		...
		public async Task<IActionResult> OnPostReviewAsync(int FoodID, int StarReview, string content_review, IFormFile fileupload, int _OrderID)
		{
			...
			return RedirectToPage("/User/MyAlternateOrder", new { orderId = _OrderID });
		}
	}
}
